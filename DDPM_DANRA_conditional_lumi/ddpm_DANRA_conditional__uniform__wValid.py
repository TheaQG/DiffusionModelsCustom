...
if __name__ == '__main__':
    ...
    cond_str = 'uniform_cond_lsm_topo_random__' + loss_type + '__' + str(n_seasons) + '_seasons' + '_ValidSplitInTime_9yrs'
    var_str = var
    model_str = 'DDPM_conditional_uniform'
    ...
    # Define training dataset, with cutouts enabled and data from zarr, and uniform conditional
    ...
    # Define validation dataset, with cutouts enabled and data from zarr, and uniform conditional

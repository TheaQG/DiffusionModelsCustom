...
if __name__ == '__main__':
    ...
    SAVE_FIGS = False
    PATH_SAVE = '/home/theaqg/Figures'#'/Users/au728490/Documents/PhD_AU/PhD_AU_material/Figures'
    PATH_SAMPLES = PATH_SAVE + '/Samples/Samples_64x64__lsm_topo'
    NAME_SAMPLES = 'Generated_samples_64x64__lsm_topo__epoch_'
    NAME_FINAL_SAMPLES = f'Final_sample__lsm_topo__ex__{var}_generated_samples_64x64'
    NAME_LOSSES = f'Training_losses_64x64__lsm_topo__ex__{var}'
    ...
    PATH_LSM = '/home/theaqg/Data_DiffMod/data_lsm/truth_DK/lsm_dk.npz'
    PATH_TOPO = '/home/theaqg/Data_DiffMod/data_topo/truth_DK/topo_dk.npz'
    ...
    fig.savefig(PATH_SAVE + f'/ddpm_conditional__{var}_lsm_topo.png', dpi=600, bbox_inches='tight', pad_inches=0.1)
    ...
    checkpoint_dir = '/home/theaqg/ModelCheckpoints/DDPM_DANRA/'#../../ModelCheckpoints/DDPM_DANRA/
    checkpoint_name = 'DDPM_conditional__lsm_topo_2.pth.tar'
    ...
    for epoch in range(epochs):
        ...
        if (epoch == 0 and PLOT_EPOCH_SAMPLES) or (((epoch + 1) % 10) == 0 and PLOT_EPOCH_SAMPLES) or (epoch == (epochs - 1) and PLOT_EPOCH_SAMPLES):
            ...
            fig2, axs2 = plt.subplots(1, n, figsize=(8,3))
            ...
            for i in range(n):
                ...
                axs2[i].imshow(img, cmap='viridis')
                axs2[i].set_title(f'Season: {y[i].item()}')
            fig.tight_layout()
            fig2.tight_layout()


            fig.savefig(PATH_SAMPLES + NAME_SAMPLES + str(epoch+1) + '_norm.png', dpi=600, bbox_inches='tight', pad_inches=0.1)
            
            fig2.savefig(PATH_SAMPLES + NAME_SAMPLES + str(epoch+1) + '.png', dpi=600, bbox_inches='tight', pad_inches=0.1)
            plt.close(fig)
            plt.close(fig2)
    ...
    fig2.savefig(PATH_SAMPLES + NAME_FINAL_SAMPLES + '_norm.png', dpi=600, bbox_inches='tight', pad_inches=0.1)
    plt.close()

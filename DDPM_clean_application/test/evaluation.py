...
if __name__ == '__main__':
    ...
    cond_str = 'ERA5_cond_lsm_topo_random__' + loss_type + '__' + str(n_seasons) + '_seasons' + '_ValidSplitInTime_9yrs' + scale_str + '_test'  #- 'sdfweighted' '4' seasons
    ...
    SAVE_PATH = 'samples/TEST1/eval_samples/'
    SAVE_PATH = EVAL_SAMPLES_DIR + SAVE_PATH
    SAVE_NAME =  model_str + '__' + var_str + '__' + im_dim_str + '__' + cond_str + '__' + str(n_samples_gen) + '_samples.npz'
    FIG_PATH = '/Users/au728490/Documents/PhD_AU/Python_Scripts/DiffusionModels/DDPM_clean/figures/'
    # Load generated images, truth evaluation images and lsm mask for each image
    gen_imgs = np.load(SAVE_PATH + 'gen_samples.npz')['arr_0']
    eval_imgs = np.load(SAVE_PATH + 'eval_samples.npz')['arr_0']
    lsm_imgs = np.load(SAVE_PATH + 'lsm_samples.npz')['arr_0']
